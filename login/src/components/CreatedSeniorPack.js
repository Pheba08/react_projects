...
const CreatedSeniorPack = () => {
    ...
    const handleEditSeniorPack = () => {
        navigate("/editseniorpack");
    };
            ...
            <div className="mb-10">
                ...
                <div className="max-w-[1262px] mx-auto bg-white rounded-3xl mt-8 ">
                    ...
                    <div className="bg-[#94BDEB] rounded-2xl h-[80px] w-[1262px] p-3 flex items-center justify-between">
                        ...
                        <button onClick={handleEditSeniorPack} className="mr-4 bg-[#173E88] text-white px-8 py-2 rounded-md hover:bg-[#0f2d5c]">
                            Edit Pack
                        </button>
                    </div>
                </div>
...
export default CreatedSeniorPack;
