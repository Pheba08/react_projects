    ...
    if (location.state?.updatedQualification) {
      setQualifications((prevQualifications) =>
        prevQualifications.map((q) =>
          q.id === location.state.updatedQualification.id
                ...
                <tbody>
                  {qualifications.map((qualification, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-left text-gray-500 text-[12px] text-[#6D6B6B] font-poppins">
                        {qualification.description}
                      </td>
                      <td
                        className="px-4 py-2 text-center cursor-pointer w-[5%]"
                        onClick={() =>
                          navigate("/EditQualification", {
                            state: { qualification },
                          })
                        }
                      >
...
// <td
//   className="px-4 py-2 text-center cursor-pointer w-[5%]"
//   onClick={() => navigate("/EditQualification")}
// >
//   <img
//     src={EditButton}
//     alt="Edit"
