          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-[linear-gradient(180deg,_rgba(80,131,205,0.3)_0%,_rgba(80,131,205,0.05)_100%)]">
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Joined Date</th>
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Name</th>
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Certificates</th>
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Contact Number</th>
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Account Status</th>
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Reselling</th>
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Counselling</th>
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Approve Status</th>
                <th className="text-left px-4 py-2 text-[12px] text-[#173E88] font-poppins">Remove</th>
              </tr>
            </thead>
            {/* Table Section */}
{/* Filtered Users */}
  ...
  {users
    ...
    .map((user, index) => (
      ...
      >
        ...
        <td className="px-4 py-2 text-left text-[12px] text-black font-poppins">{user.counselling}</td>
        ...
        <td className="px-4 py-2 text-center cursor-pointer" onClick={() => removeUser(user.id)}>
          <img src={DeleteButton} alt="Delete" className="w-3 h-3 mx-auto" />
        </td>
      </tr>
    ))}
</tbody>
