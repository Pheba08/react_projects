        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-[#E9F3FC] p-4 pl-8 pr-8 rounded-lg shadow-lg w-[350px] relative">
            ...
            <div className="mt-4">
              <select className="w-full rounded-lg border-0 mt-1 bg-[#94BDEB] ">
                <option>All</option>
                <option>New counselors</option>
                <option>Existing counselors</option>
              </select>
            </div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-[linear-gradient(180deg,_rgba(80,131,205,0.3)_0%,_rgba(80,131,205,0.05)_100%)]">
                <th className="px-4 py-2 text-left text-[12px] text-[#173E88] font-poppins">
                  Joined Date
                </th>
                <th className="px-4 py-2 text-left text-[12px] text-[#173E88] font-poppins">
                  Name
            ...
            <tbody>
              {users
                ...
                .map((user) => (
                  <tr key={user.id} className="border-b border-[#94BDEB]">
                    <td className="px-4 py-2">{user.joinedDate}</td>
                    <td className="px-4 py-2">{user.name}</td>
                    <td className="px-4 py-2">{user.certificates}</td>
                    <td className="px-4 py-2">{user.contactNumber}</td>
                    <td className="px-4 py-2">{user.accountStatus}</td>
                    <td className="px-4 py-2">{user.reselling}</td>
                    <td className="px-4 py-2">{user.counselling}</td>
                    <td className="px-4 py-2">{user.approveStatus}</td>
                    <td
