          ...
          <div className="p-3">
            ...
            <ul className="pt-1 space-y-2 text-left w-full">
              {[
                ...
                { name: "Students payments", icon: dashboard, path: "/counsellors" },
                { name: "Counsellors payments", icon: dashboard, path: "/institutions" },
                { name: "Institutions payments", icon: dashboard, path: "/institutions" },
                { name: "Set pricing", icon: dashboard, path: "/institutions" },
              ].map((item, index) => (
                <li
                  key={index}
                  className="flex items-center gap-3 text-[12px] cursor-pointer px-3 py-[5px] transition-all rounded-l-2xl w-full block 
