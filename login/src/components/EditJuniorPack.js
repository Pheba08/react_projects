...
import JuniorApprovedQuestions from "./JuniorApprovedQuestions";

const EditJuniorPack = () => {
        ...
        <div className="min-h-screen bg-[#E9F3FC] overflow-hidden">
            ...
            <div className="mt-4 ml-8 w-full max-w-7xl">
                ...
                <div className="p-4">
                    ...
                    {activeTab === "approved" && <JuniorApprovedQuestions />}
                </div>
            </div>
        </div>
    );
