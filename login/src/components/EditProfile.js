      ...
      <div className="max-w-6xl mx-auto bg-white rounded-lg p-6 mt-10">
        ...
        <div className="mb-4 p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-left">
            ...
            <div className="flex flex-col items-start">
              ...
              <input
                ...
                className="w-[200px] h-[30px] p-2 text-[9px] border-[#94BDEB] rounded-md placeholder-[#A8A8A8]"
              />
              ...
              <select className="w-[200px] h-[30px] p-2 text-[9px] border-[#94BDEB] rounded-md text-[#A8A8A8]">
            ...
            <div className="flex flex-col items-end">
              <div className="w-[200px] mb-4">
                ...
                <textarea
                  placeholder="Address"
                  className="w-full h-[140px] p-2 text-[9px] border-[#94BDEB] rounded-md placeholder-[#A8A8A8]"
                ></textarea>
              </div>

              {/* Certificate Upload Section */}
              <div className="w-[200px] h-[30px] mt-4 p-2 bg-[#94BDEB80] border-[1px] border-[#94BDEB] rounded-md flex justify-items-end gap-[72px] items-center">
          ...
          <div className="flex justify-end mt-4">
            <button className="bg-[#173E88] text-white text-[10px] px-10 py-1 rounded-md">
              Save
            </button>
          </div>
        </div>
