...
const CompleteInstitutionProfile = () => {
    ...
    <div className="min-h-screen bg-[#E9F3FC] overflow-hidden">
      ...
      <div className="mt-1 ml-12">
        <div className="col-span-3 flex flex-col gap-3">
          <h1 className="text-[35px] text-left text-[#030303] font-nunito font-medium">
            Complete Your Institution Profile
          </h1>
          <h2 className="text-[16px] text-left text-[#030303] font-nunito font-medium pt-4 pb-3">
            Account Details
          </h2>
          ...
          <div className="bg-[#F9F9F9] p-10 rounded-xl text-left text-[#030303] space-y-4 mb-5 mr-10">
            ...
            <div className="flex justify-center mt-6">
              <button className="px-28 py-2 text-white bg-[#173E88] rounded-md">Continue</button>
            </div>
          </div>
        </div>
      </div>
...
export default CompleteInstitutionProfile;
